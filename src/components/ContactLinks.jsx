...
const ContactLinks = ({ activeWhiteBg, classes }) => {
  return (
    <ul className={`flex flex-col gap-4 ${classes} lg:flex-row xl:flex xl:justify-end xl:gap-6 mb-4 ${arimo.className} ${activeWhiteBg ? 'text-primaryColor' : 'text-white'}`}>
      <li>
